      ...
      <main>
        <section>
          ...
          >
            ...
            <div className="video-home-contaier">
              <div
                style={{
                  display: "flex",
                  justifyContent: "center",
              ...
              >
                <button className="cool-button" onClick={startWebcam}>
                  start
                </button>
                <button className="cool-button" onClick={stopWebcam}>
                  stop
                </button>
              </div>
              <div className="video">
